...
for f in $FAFiles; 
    do 
        ...
        antsRegistrationSyNQuick.sh -d 3 -f FA/${id}_FA_reorientedOriginZero.nii -m T1/${id}_T1_dirMtxI.nii.gz -o transformations/T1ToFA_${id}_ \
        ...
        antsApplyTransforms -d 3 -i atlas/HarvardOxfordSubcortical.nii.gz -r FA/${id}_FA_reorientedOriginZero.nii\
                    -o regResults/${id}_HarvardSubcortTransformedtoFA.nii -n NearestNeighbor -t transformations/T1ToFA_${id}_0GenericAffine.mat \
