...
colourFunc2.AddRGBPoint(9, 1.0, 0.0, 1.0)
...
colourFunc2.AddRGBPoint(15, 0, 0, 0)
colourFunc2.AddRGBPoint(16, 0, 0, 0)
colourFunc2.AddRGBPoint(17, 0.0, 0.0, 0.0)
colourFunc2.AddRGBPoint(18, 0.0, 0.0, 0.0)
...
opacityFunc2.AddPoint(15, 0.0)
opacityFunc2.AddPoint(16, 0.0)
opacityFunc2.AddPoint(17, 0.0)
opacityFunc2.AddPoint(18, 0.0)
...
colourFunc3.AddRGBPoint(12, 0.0, 0.0, 0.0)
...
colourFunc3.AddRGBPoint(17, 1.0, 1.0, 0.5)
colourFunc3.AddRGBPoint(18, 0.0, 0.0, 0.0)
...
colourFunc4.AddRGBPoint(4, 0.0, 0.0, 0.0)
...
colourFunc4.AddRGBPoint(9, 0.0, 1.0, 0.0)
...
colourFunc4.AddRGBPoint(19, 0, 0, 0)
colourFunc4.AddRGBPoint(20, 0, 0, 0)
colourFunc4.AddRGBPoint(21, 0.0, 0.0, 0.0)
colourFunc4.AddRGBPoint(22, 0, 0, 0)
colourFunc4.AddRGBPoint(23, 1, 0.5, 0.25)
...
colourFunc4.AddRGBPoint(40, 0, 0.5, 0.5)
colourFunc4.AddRGBPoint(41, 1.0, 0.0, 0.5)
...
colourFunc4.AddRGBPoint(47, 1.0, 1.0, 0.0)
...
opacityFunc4.AddPoint(19, 0.0)
opacityFunc4.AddPoint(20, 0.0)
opacityFunc4.AddPoint(21, 0.0)
opacityFunc4.AddPoint(22, 0.0)
opacityFunc4.AddPoint(23, 1.0)
