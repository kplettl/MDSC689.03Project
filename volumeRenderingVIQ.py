...
colourFunc2.AddRGBPoint(1, 1, 0, 0)
...
colourFunc2.AddRGBPoint(12, 0.4, 0.4, 0.0)
...
colourFunc3.AddRGBPoint(4, 0.5, 0.17, 0.88)
...
colourFunc3.AddRGBPoint(12, 1.0, 0.5, 1.0)
...
colourFunc4.AddRGBPoint(24, 0, 0, 1)
...
colourFunc4.AddRGBPoint(41, 0.0, 0.0, 0.0)
